...
def addBolt (r_shank, l_bolt, r_head, l_head,
    ...
    if support==1 and mat_cte.LAYER3D_H > 0:
        ...
        if headdown == 1:
            ...
            zposheadsup1 = l_bolt - l_head - mat_cte.LAYER3D_H
        ...
        if headdown == 1:
            ...
            zposheadsup2 = l_bolt - l_head - 2* mat_cte.LAYER3D_H
    ...
    if supp_nut == 1 and mat_cte.LAYER3D_H > 0:
        ...
        if headdown == 1:
            pos_supnut1 = FreeCAD.Vector (0, 0,
                                          l_bolt - l_nut - mat_cte.LAYER3D_H)
        else:
            pos_supnut1 = V0
        rot30z = FreeCAD.Rotation(VZ,30)
        ...
        if headdown == 1:
            pos_supnut2 = FreeCAD.Vector(0,0,
                                         l_bolt - l_nut - 2*mat_cte.LAYER3D_H)
        else:
            pos_supnut2 = V0
